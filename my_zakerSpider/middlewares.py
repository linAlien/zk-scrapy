...
from my_zakerSpider.settings import USER_AGENT_LIST


class MyZakerspiderSpiderMiddleware(object):
...
class MyZakerspiderDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
